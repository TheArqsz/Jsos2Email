...
class StudentMail:
	...
	def __init__(self, email, password, server_host='student.pwr.edu.pl', port=587):
		self.email = email
	...
	def prepare_message(self, message=None):
		"""Creates basic MIMEMultipart message
	...
	def prepare_headers(self, subject='', msg_from='jsos_bot@pwr.edu.pl'):
		"""Prepares headers for MIMEMultipart message
	...
	def prepare_content(self, content, msg_from='jsos_bot@pwr.edu.pl'):
		"""Adds html content to MIMEMultipart message
